...
class Project(models.Model):
    ...
    problem_statement = models.TextField(blank=True, default="", help_text="Problem addressed by this project")
    solution = models.TextField(blank=True, default="", help_text="How the problem was solved")
    outcome = models.TextField(blank=True, default="", help_text="Results and insights from the project")
